      ...
      <>
        ...
        <div className="funkosInformation">
          <h3 className="descriptiveText">
            ...
            centímetros generalmente y un coste aproximado en Estados Unidos
            desde nueve o diez dólares, tienen como otras características: unos
            cuerpos reducidos y cabezas extra grandes en comparación con el
            tamaño de todo el cuerpo, además de unos ojos grandes negros sin
            expresión, una nariz triangular minúscula y generalmente no tienen
            boca (dependiendo del personaje). El diseño peculiar de estas
            figuras, con su propia propiedad intelectual, está considerado como
            uno de los grandes valores de Funko.
          </h3>
